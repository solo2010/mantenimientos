<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="{{ route('principal') }}">Registro Preventivo</a>
    </div>
      ...
      <ul class="nav navbar-nav">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href=" {{ route('usuarios.crear') }}">Crear Usuario</a></li>
            <li><a href=" {{ route('usuarios.index') }}">Mostrar Usuarios</a></li>
          </ul>
        </li>
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href=" {{ route('usuarios.crear') }}">Registrar Equipo</a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="#">Nuevo Mantenimiento</a></li>
            <li><a href="#">Mantenimientos Realizados</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="#">Mantenimientos Programados</a></li>
          </ul>
        </li>
        <li class="dropdown">
